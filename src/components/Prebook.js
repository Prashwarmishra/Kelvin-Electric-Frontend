        ...
        {!isLoggedin ? (
          ...
          <div className="testride-wrapper">
            <p className="testride-description">
              ...
              reducing city noise and exhaust gas, while taking advantage of the
              benefits of modern electric mobility. Kelvin electric offers you
              long ranges, short charging times and the possibility to
              individualize your E-Scooter according to your needs... Of course:
              Driving fun and the feeling of freedom are also absolutely
              guaranteed!
            </p>
